...
public class AssertJTest {
    ...
    void test2() {
        ...
        Assertions.assertThat(list).isNotEmpty().contains("1").doesNotContainNull().containsSequence("2", "3");
    ...
    void test7() {
        ...
        Assertions.assertThat(3.14d)
                ...
                .isEqualTo(3.1, offset(0.1d))  // 소수점 첫째자리까지 비교
                .isEqualTo(3.14);
    ...
    public void test8() {
        ...
        // then
        // SoftAssertions : 동시에 여러 테스트를 진행하고, 중간에 에러가 나도 모든 검사를 수행한 후에 결과를 보여줌.
