...
import com.study.Ex22TDD.ApiController;
...
class ApiControllerTest {
    ...
    @MockBean   // ApiController에서 주입받은 Bean 객체에 대해서 Mock형태로 객체 생성.
    ...
    void loginAction1() throws Exception {
        // given when
        // loginAction 함수가 제대로 동작하는 조건을 기술
